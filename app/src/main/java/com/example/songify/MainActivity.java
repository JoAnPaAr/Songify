...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewCancion = findViewById(R.id.rv_Cancion);
        recyclerViewCancion.setHasFixedSize(true);

        layoutManager = new LinearLayoutManager(this);
        recyclerViewCancion.setLayoutManager(layoutManager);

        mAdapter = new RecyclerViewAdapter(listaCanciones, this);
        recyclerViewCancion.setAdapter(mAdapter);
